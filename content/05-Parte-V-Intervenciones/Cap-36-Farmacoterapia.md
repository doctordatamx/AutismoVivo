...
parte: "Parte-V"
numero: 36
titulo: "Farmacoterapia (síntomas asociados, no curar autismo)"
dg-publish: true
dg-home: false
...
No existen fármacos oficialmente aprobados para **síntomas nucleares** del TEA ([@wang2025]; [[2025-Wang-understanding-autism]]). En clínica se tratan comorbilidades. Pipelines experimentales muestran **resultados mixtos**; la oxitocina ilustra la necesidad de **medicina de precisión** ([@boulton2026]).

## Contenido

### Uso clínico actual

Prescripción según comorbilidad (regulación emocional, TDAH, sueño, etc.): psicoestimulantes, antipsicóticos, antidepresivos, fármacos para sueño ([@wang2025]). **No** mejoran directamente habilidades sociales nucleares.

### Pipeline experimental

| Enfoque | Estado resumido |
|---------|-----------------|
| **Oxitocina** nasal | Ver sección siguiente — one-size-fits-all **no** funciona de forma fiable |
| **Balovaptan** (AVPR1a) | Breakthrough Therapy FDA 2018; fase 2 positiva; fase 3 (2022) **negativa** en adultos y niños |
| **Antioxidantes** | Señales en modelos; evidencia clínica limitada |
| **PPAR** (p. ej. pioglitazona) | Promesa en modelos animales |
| **mTOR** (rapamicina) | Modelos (p. ej. TSC); relevancia en subgrupos |
| **Sinapsis / E-I** (NMDA, mGluR5, GABA, bumetanide, arbaclofen) | Racional fuerte; clínica irregular ([@zabetakis2026]) |
| **Nutracéuticos** (Zn, vit. D/B) | Preliminar — no sustituyen atención estándar ([@zabetakis2026]) |
| **Probióticos / FMT** | GI a veces; síntomas nucleares heterogéneos; FMT open-label sin RCT definitivo ([@zhang2025mgba]); LGR-1 prenatal solo en **ratones** ([@yang2025lgr1]) — no traducir a clínica |
| Otros | GLP-1, memantina, dieta cetogénica, CBD, etc. — inconsistentes |

CAM dietética/suplementos: ver [[Cap-37-Complementarios-pseudociencia]] ([@doherty2025]). Crítica fuerte a causalidad microbiota→TEA: ([@mitchell2025]; [[2025-Mitchell-Bishop-microbiome-autism-critique]]). Grumbach et al. ([@grumbach2025]) enlazan patrones de actividad cerebral TEA con neurotransmisores y con el mapa de **ketamina** — hipótesis E/I, **no** indicación de ketamina terapéutica.

![TEA ≈ ketamina](assets/figures/Cap-36/grumbach2025-fig2-ketamine.png)

*Figura. Patrón cerebral TEA ≈ ketamina: hipótesis E/I (no indica usar ketamina como tratamiento). ([@grumbach2025]; licencia CC BY 4.0).*


### Oxitocina: de “fracaso” a marco de precisión (2026)

Boulton & Guastella ([@boulton2026]; [[2026-Boulton-Guastella-oxytocin-precision-medicine]]):

- Ensayo grande (~**n=277**, 3–17 a.): **sin** diferencia vs placebo en retiro social; meta-análisis: efectos sociales **pequeños**, posibles sesgos
- Señales mejores en **niños pequeños** (≈3–5 a.) en algunos ensayos; OT periférica más baja en infancia
- Moderadores: polimorfismos *OXTR*, OT basal baja, **dosis** (posible U invertida; más no es mejor), frecuencia (cada 2 días vs diario), + entrenamiento psicosocial
- Placebo sustancial en TEA; medir con biomarcadores objetivos + vida real
- Conclusión: abandonar régimen estándar único → estratificación

Patwardhan et al. contextualizan mecanísticamente esta necesidad de precisión: la **hipótesis de la red de saliencia social (SSN)** propone que los síntomas sociales nucleares emergen de una disrupción en la priorización atencional/motivacional de estímulos sociales, modulada por señalización de oxitocina ([@patwardhan2025]; [[2025-Patwardhan-social-salience-network-oxytocin]]) — un marco de red neural que ayuda a explicar por qué solo ciertos subgrupos (por edad, *OXTR*, dosis) responderían a la oxitocina.

### Diana preclínica candidata: dopamina nigroestriatal

En el modelo murino de exposición prenatal a valproato, la potenciación de la proyección dopaminérgica SNc→estriado dorsomedial resultó necesaria y suficiente para déficits sociales y conductas restringidas/repetitivas, mediada por receptores D1/D2; su modulación farmacológica normalizó el fenotipo en ratones ([@zheng2025]; [[2025-Zheng-nigrostriatal-VPA-dopamine]]). Evidencia **exclusivamente preclínica**, pero abre una diana dopaminérgica candidata para RRB, actualmente con opciones farmacológicas limitadas.
