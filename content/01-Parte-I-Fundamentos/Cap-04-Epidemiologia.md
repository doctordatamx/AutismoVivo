...
parte: "Parte-I"
numero: 4
titulo: "Epidemiología: prevalencia, tendencias, sesgos de medición"
dg-publish: true
dg-home: false
...
La prevalencia reportada del TEA sigue subiendo. Estimaciones globales ~**1/100** niños; en vigilancia ADDM (EE.UU., 2020) alcanzó **2,76%** (~**1 de cada 36**) en 0–8 años ([@wang2025]; [[2025-Wang-understanding-autism]]), frente a ~1/88 citado en revisiones de 2012 ([@chaste2012]). Parte del aumento se explica por criterios, conciencia y acceso; no se descarta contribución ambiental.

## Contenido

### Introducción

La epidemiología del TEA alimenta políticas y narrativas de “epidemia”. Distinguir **prevalencia detectada** de **incidencia** es esencial ([@chaste2012]; [@wang2025]).

### Estimaciones actuales (actualización 2025)

Según Wang et al. ([@wang2025]; [[2025-Wang-understanding-autism]]):

| Estimación | Valor | Contexto |
|------------|-------|----------|
| Global (promedio) | ~1/100 | Amplia heterogeneidad |
| Rango reportado | 0,22%–3,60% | Según país/método |
| ADDM EE.UU. 2000 | 0,67% | Niños vigilados |
| ADDM EE.UU. 2020 | **2,76% (~1/36)** | 0–8 años; ratio H:M **3,8:1** |
| Australia Occidental | 0,51% (2010) → 2,07% (2020) | Tendencia al alza |
| N. África / Medio Oriente (21 países) | ~0,30% estable 1990–2019 | Contraste regional |

Comparación histórica con Chaste & Leboyer ([@chaste2012]): CDC ~1/110 (2006) y ~1/88 (2008). La serie ADDM 2000→2020 implica un aumento ~**cuádruple** en la prevalencia reportada en EE.UU. ([@wang2025]).

### Variación geográfica, racial y socioeconómica

- En 2020, prevalencia a los 8 años en EE.UU. varió de **2,31%** (Maryland) a **4,49%** (California) ([@wang2025]).
- Por primera vez en ADDM, la prevalencia en niños blancos fue **menor** que en otros grupos raciales/étnicos (inversión de tendencia previa) ([@wang2025]).
- En Australia Occidental, prevalencia en indígenas ≈ **2/3** de la de no indígenas ([@wang2025]).
- Países de bajos ingresos: prevalencia a menudo **desconocida** por falta de vigilancia; las disparidades reflejan más acceso/estigma que incidencia biológica ([@wang2025]).

### ¿Por qué sube la cifra?

Factores documentados ([@wang2025]; [@chaste2012]):

1. Cambios de criterios y herramientas
2. Mayor conciencia y planes de discapacidad/seguros
3. Diagnóstico más temprano (tendencia 2000–2023)
4. SES alto y padres con más acceso educativo → más diagnósticos
5. Posible componente ambiental (hipótesis abierta; ver [[Cap-05-Etiologia]])
